...
DONADDR1="MCLB: mbNck1MdshduJD1TLGc7Cp6MHtHy8HRPi8"
...
NODE_NAME="Millennium Club"
COIN_NAME="millenniumclubcoin"
COIN_TICKER="MCLB"
COIN_PATH="/usr/local/bin"
COIN_DAEMON="millenniumclubcoind"
COIN_CLI="millenniumclubcoin-cli"
COIN_PID="millenniumclubcoind.pid"
COIN_FOLDER="/root/.millenniumclubcoin"
COIN_CONFIG="millenniumclubcoin.conf"
COIN_SERVICE="millenniumclubcoin.service"
COIN_PORT="3333"
RPC_PORT="33331"
...
# Masternode commands
MNCLI_STATUS="masternode status"                                                                    # Masternode status command, usually 'masternode status' or 'getmasternodestatus'.
MNCLI_KEYGEN="masternode genkey"                                                                    # Generate masternode key, usually 'masternode genkey' or 'createmasternodekey'.
...
function display_logo() {
    ...
    echo -e "                            that are in need of help                           ${N}"; sleep $DELAY
    echo -e "                                                                               ${N}"; sleep $DELAY
    echo -e "───────────────────────────────────────────────────────────────────────────────${N}"; sleep $DELAY
}
